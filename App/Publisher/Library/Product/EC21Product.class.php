...
//            $this->setError('无法提交产品，可能是抵达产品数目上限');
            return false;
        }
    }
    ...
    public function getLastSubmit(Member $member){
        ...
        $content = HttpRequest::get($url,'',$member->getCookie());
...
//        $page = HttpRequest::get('http://www.ec21.com/global/fileup/UploadProImageForm.jsp?type=PI&pnum=0',$member->getCookie());
//        if(preg_match('/var\stemp_file_name\s=\s\"([\w\d_]+)\"/',$page,$matches) and isset($matches[1])){
