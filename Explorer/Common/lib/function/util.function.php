...
function php_env_check(){
    ...
    if(!path_writable(DATA_PATH)) $error.= '<li>'.$base_path.'data	'.$L['php_env_error_path'].'</li>';
    ...
    if(!function_exists('imagecreatefromjpeg'))$error.= '<li>'.$L['php_env_error_gd'].':imagecreatefromjpeg</li>';
    if(!function_exists('imagecreatefromgif'))$error.= '<li>'.$L['php_env_error_gd'].':imagecreatefromgif</li>';
    if(!function_exists('imagecreatefrompng'))$error.= '<li>'.$L['php_env_error_gd'].':imagecreatefrompng</li>';
    if(!function_exists('imagecolorallocate'))$error.= '<li>'.$L['php_env_error_gd'].':imagecolorallocate</li>';
    return $error;
}
